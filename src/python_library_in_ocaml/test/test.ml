  ...
  [%expect
    ...
    ((type_name Loc) (type_vars ())
     (definition
      (Py_Alias
       (Py_Tuple
        ((Py_Atomic Py_Int) (Py_Atomic Py_Int) (Py_Atomic Py_Int)
         (Py_Atomic Py_Int))))))

    ((type_name WithLoc) (type_vars (A))
     (definition
      (Py_TypedDict ((data (Py_Var A)) (loc (Py_Atomic (Py_Custom Loc)))))))

    ((type_name LocatedName) (type_vars ())
     (definition
      (Py_Alias (Py_Apply (Py_Custom WithLoc) ((Py_Atomic Py_String)))))) |}]
